...
ColdFusion Markup Language (CFML) is a great programming language for beginners because it was written to make the programmerâ€™s job easy and not care if the computerâ€™s job is hard. In this brief introduction weâ€™ll look at key language features you need to get started.
