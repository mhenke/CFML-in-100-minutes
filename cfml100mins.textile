...
For the purposes of our next section I'm going to return the chef instance itself from the method. If you wanted to picture the metaphor, imagine you are looking at your chef @frank@. You sayFrank, go make my toast, he tells you he's making the toast, goes to make it, then comes back to you to receive more instructions. He's returning himself to you. Here's how we implement it in code:
...
<code>
 ...
 <cfdump var="#favorite_colors[3]#" />
 <cfdump var="#favorite_colors.1#" />
 <cfdump var="#favorite_colors[ArrayLen(favorite_colors)]#" />
</code>
</pre>
</td>
<td>
...
puts favorite_colors[5] favorite_colors<<"orange" 
puts favorite_colors[5] puts favorite_colors
...
sorted_colors = favorite_colors.sort sorted_colors.each do |color| 
puts "#{color} is #{color.length} letters long" end 
puts sorted_colors.join("&") 
target = "green" 
position = favorite_colors.index(target) puts "
