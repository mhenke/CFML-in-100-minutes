...
*  @=@ is an _assignment_. It meanstake whats on the right side and stick it into whatever is on the left side (or its __telling__ **not** __asking__ .)
* @==@ is a _question_. It means the thing on the right equal to the thing on the left (or its __asking__ **not** __telling__ .)
