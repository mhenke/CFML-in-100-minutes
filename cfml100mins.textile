...
Only _one_ section of the @if@ / @elsif@ / @else@ structure can have its instructions run. If the @if@ is @true@, for instance, CFML will never look at the @else if@. Once one block executes, thats it.
