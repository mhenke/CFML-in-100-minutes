...
For the script example, @myprogram.cfm@ would have beginning and closing @<cfoutput>@.
...
For the Ruby script example, the part 1 would be first in @my_program.rb@ then the part 2.
