...
CFML (ColdFusion Markup Language) is thought of by many as an old programming language, but it actually has been continuously improved by Allaire, Macromedia, and now Adobe. ColdFusion originated as proprietary technology, however, it is becoming a less closed technology through the availability of competing products. Open source technology CFML options are available like Railo and OpenBD. ColdFusion was invented by Jeremy and JJ Allaire in 1995. Their idea for ColdFusion was originally designed to make it easier to connect simple HTML pages to a database, but ColdFusion now includes advanced features for enterprise integration and application development. 
...
h2. 3. Components, Functions, and Objects
...
Inside the @cffunction@ tags we'd put the instructions for how the chef should make the toast.
