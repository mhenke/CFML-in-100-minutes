...
In CFML, a ColdFusion component (CFC) file contains data and functions. Components are a building for Objects. Objects know information, called attributes, and they can do actions, called methods. In ColdFusion @cffunction@ tag is used to define methods within a CFC.
